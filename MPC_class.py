...
class MPCController:
    ...
    def compute_control(self, x_0):
        ...
        if self.disturbance_estimation_active:
            ...
            # Keep initial estimate (e.g., gravity) until first step is done
            # Or set to zero if preferred: self.d_est = np.zeros(8)
            pass  # Keep self.d_est as initialized (e.g., d_gravity)
